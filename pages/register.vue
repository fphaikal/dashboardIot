    ...
    <div class="w-full rounded-lg shadow dark:border md:mt-0 xl:p-0 bg-dark dark:border-gray-700 text-white">
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6" action="#">
          ...
          <button @click.prevent="register"  type="submit" class="w-full btn btn-primary">Create an account</button>
          <p class="text-sm font-light text-gray-400">Already have an account? <a href="login" class="font-medium text-primary hover:underline">Login Here</a></p>
        </form>
      </div>
    </div>
  </div>
